...
docker run -d -it -p 0.0.0.0:21:21 -p 0.0.0.0:30091-30100:30091-30100 --restart unless-stopped --name=${app} --mount type=bind,source=/home/data,target=/home/data ${app}
